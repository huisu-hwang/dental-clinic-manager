...
export class PublishOrchestrator {
     ...
     * 5. 쓰레드 (Threads API)
     */
    async publishAll(itemId, platforms, content, snsDelayMinutes = 30) {
        const publishedUrls = {};
        const errors = {};
        // 1. 네이버 블로그
    ...
    async logPublish(itemId, platform, success, url, error, duration) {
