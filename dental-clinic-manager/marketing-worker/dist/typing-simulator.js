 ...
 * 셀렉터를 클릭 후 타이핑
 */
export async function humanTypeInto(page, selector, text) {
 ...
 */
export async function typeBodyContent(page, body, onImageMarker, onHeading) {
 ...
 */
export async function handleDraftPopup(page) {
    try {
 ...
 * 해시태그 입력 (발행 패널에서)
 */
export async function typeHashtags(page, hashtags) {
