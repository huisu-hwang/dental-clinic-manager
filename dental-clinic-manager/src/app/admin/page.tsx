    ...
    return (
      <div className="min-h-screen bg-at-surface-alt flex items-center justify-center">
        <div className="text-center">
          ...
          <h1 className="text-2xl font-bold text-at-text mb-2">접근 제한</h1>
          <p className="text-at-text-secondary">마스터 관리자만 접근할 수 있습니다.</p>
        </div>
      </div>
    )
  }
    ...
    <div className="min-h-screen bg-at-surface-alt">
          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center space-x-4">
              ...
              <div>
                ...
                <p className="text-sm text-at-text-weak">Hi Clinic 시스템 관리</p>
              </div>
            </div>
            <div className="flex items-center space-x-4">
              <button
                onClick={() => setShowProfile(true)}
                className="text-sm text-at-text-weak hover:text-slate-200 hover:underline cursor-pointer transition-colors"
                title="계정 정보"
              >
                {user.email}
              </button>
      ...
      <div className="container mx-auto px-4 md:px-8 py-8">
        ...
        <main>
            ...
            <div className="space-y-6">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                <div className="bg-white p-6 rounded-xl shadow-at-card border border-at-border">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm text-at-text-secondary">전체 병원</p>
                      <p className="text-3xl font-bold text-at-text mt-1">-</p>
                    </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-at-card border border-at-border">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm text-at-text-secondary">전체 사용자</p>
                      <p className="text-3xl font-bold text-at-text mt-1">-</p>
                    </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-at-card border border-at-border">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm text-at-text-secondary">월 매출</p>
                      <p className="text-3xl font-bold text-at-text mt-1">₩0</p>
                    </div>
                ...
                <div className="bg-white p-6 rounded-xl shadow-at-card border border-at-border">
                  <div className="flex items-center justify-between">
                    <div>
                      <p className="text-sm text-at-text-secondary">시스템 상태</p>
                      <p className="text-sm font-bold text-at-success mt-1">정상</p>
                    </div>
              ...
              {/* Recent Activity */}
              <div className="bg-white p-6 rounded-xl shadow-at-card border border-at-border">
                <h2 className="text-lg font-bold text-at-text mb-4">최근 활동</h2>
                <div className="space-y-3">
                  <p className="text-sm text-at-text-secondary text-center py-8">
                    최근 활동 내역이 없습니다.
                  </p>
                </div>
              </div>
          ...
          {activeTab === 'users' && (
            <div className="bg-white p-6 rounded-xl shadow-at-card border border-at-border">
              <h2 className="text-xl font-bold text-at-text mb-4">사용자 관리</h2>
              <div className="text-center py-12">
                <UserGroupIcon className="h-12 w-12 text-at-text-weak mx-auto mb-4" />
                <p className="text-at-text-secondary">사용자 관리 기능은 곧 제공될 예정입니다.</p>
              </div>
            </div>
          )}
          ...
          {activeTab === 'billing' && (
            <div className="bg-white p-6 rounded-xl shadow-at-card border border-at-border">
              <h2 className="text-xl font-bold text-at-text mb-4">빌링 & 구독 관리</h2>
              <div className="text-center py-12">
                <CreditCardIcon className="h-12 w-12 text-at-text-weak mx-auto mb-4" />
                <p className="text-at-text-secondary">빌링 관리 기능은 곧 제공될 예정입니다.</p>
              </div>
            </div>
          )}
          ...
          {activeTab === 'settings' && (
            <div className="bg-white p-6 rounded-xl shadow-at-card border border-at-border">
              <h2 className="text-xl font-bold text-at-text mb-4">시스템 설정</h2>
              <div className="text-center py-12">
                <ShieldCheckIcon className="h-12 w-12 text-at-text-weak mx-auto mb-4" />
                <p className="text-at-text-secondary">시스템 설정 기능은 곧 제공될 예정입니다.</p>
              </div>
            </div>
          )}
        </main>
