    ...
    <div className="min-h-screen bg-at-surface-alt">
      <div className="max-w-6xl mx-auto p-6">
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <h1 className="text-2xl font-bold text-at-text mb-2">
            프로토콜 컴포넌트 테스트 페이지
          </h1>
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          <h2 className="text-xl font-semibold text-at-text mb-4">
            1. Enhanced Tiptap Editor 테스트
          </h2>
          <div className="space-y-4">
            <div className="text-sm text-at-text-secondary mb-2">
            ...
            <EnhancedTiptapEditor
              ...
              editable={true}
            />
            <div className="mt-4 p-4 bg-at-surface-alt rounded border border-at-border">
              <div className="text-xs font-mono text-at-text-secondary">
        ...
        <div className="bg-white rounded-lg shadow-sm p-6 mb-6">
          ...
          <div className="space-y-4">
            <div className="text-sm text-at-text-secondary mb-4">
            ...
            <div className="mb-4">
              ...
              <input
                ...
                className="w-full px-3 py-2 border border-at-border rounded-md focus:ring-at-accent focus:border-at-accent"
              ...
              <div className="text-xs text-at-text-secondary">
                ...
                <div className="flex flex-wrap gap-1">
                  {tags.map((tag) => (
                    <span
                      key={tag}
                      className="px-2 py-1 bg-at-tag text-at-accent rounded-full text-xs"
                    >
                      {tag}
                    </span>
                  ))}
