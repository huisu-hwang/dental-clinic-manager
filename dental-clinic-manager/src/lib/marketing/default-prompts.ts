...
## 환자가 읽기 쉬운 구조 (필수)
- **각 문단의 첫 줄은 전각 공백(　) 한 칸으로 들여쓰기를 시작하세요.** (예: "　치과를 방문할 때 가장 걱정되는 부분은…")
- 한 문단은 **3~4개 문장**으로 짧게 끊어 작성하세요. 길어지면 새 문단으로 분리합니다.
- 핵심 포인트는 별표 두 개로 감싸 굵게 강조하여 환자가 빠르게 훑어볼 수 있게 합니다 (예: 별표 두 개로 감싼 "중요한 부분" 형태).
- 비교/주의사항/단계 등은 하이픈(-) 글머리 기호 또는 번호(1.) 리스트로 정리합니다.
- 한 문장 안에 어려운 의학 용어가 2개 이상 들어가지 않게 풀어 씁니다.
- 환자가 가장 알고 싶을 정보를 섹션 첫 문단에 배치하세요 (역피라미드 구조).
...
## 환자가 읽기 쉬운 구조 (필수)
- **각 문단의 첫 줄은 전각 공백(　) 한 칸으로 들여쓰기를 시작하세요.**
- 한 문단은 **3~4개 문장**으로 짧게 끊어 작성하세요.
- 핵심 메시지는 **굵은 글씨**로 강조하고, 비교/혜택은 리스트로 정리합니다.
- 환자가 어렵게 느낄 의학 용어는 괄호로 쉽게 풀이합니다.
...
## 환자가 읽기 쉬운 구조 (필수)
- **각 문단의 첫 줄은 전각 공백(　) 한 칸으로 들여쓰기를 시작하세요.**
- 한 문단은 **3~4개 문장**으로 짧게 작성합니다.
- 시술 단계, 주의사항, 결과 비교는 글머리 기호 또는 번호 리스트로 정리하세요.
- 의학 용어는 환자가 이해하기 쉽도록 괄호로 풀이합니다.
