...
export default function AdminTelegramGroupSetupGuide({ onCancel }: AdminTelegramGroupSetupGuideProps) {
    return (
        <div className="p-5 bg-at-accent-light rounded-xl border border-at-border shadow-at-card">
            <div className="flex items-center gap-2 mb-4">
                <Bot className="w-5 h-5 text-at-accent" />
                <h4 className="text-sm font-bold text-at-text">새 텔레그램 그룹 연동 가이드</h4>
            </div>

            <div className="space-y-4">
                <div className="flex items-start gap-3 bg-white p-4 rounded-xl border border-at-border shadow-at-card">
                    <div className="w-6 h-6 rounded-full bg-at-tag flex items-center justify-center flex-shrink-0 mt-0.5">
                        <span className="text-xs font-bold text-at-accent">1</span>
                    </div>
                    <div>
                        <h5 className="text-sm font-semibold text-at-text">봇 초대하기</h5>
                        <p className="text-xs text-at-text-secondary mt-1 leading-relaxed">
                ...
                <div className="flex items-start gap-3 bg-white p-4 rounded-xl border border-at-border shadow-at-card">
                    <div className="w-6 h-6 rounded-full bg-at-tag flex items-center justify-center flex-shrink-0 mt-0.5">
                        <span className="text-xs font-bold text-at-accent">2</span>
                    </div>
                    <div>
                        <h5 className="text-sm font-semibold text-at-text">연동 대기 목록 확인</h5>
                        <p className="text-xs text-at-text-secondary mt-1 leading-relaxed">
            ...
            <div className="flex gap-2 justify-end mt-5">
                <Button type="button" variant="outline" size="sm" onClick={onCancel} className="bg-white hover:bg-at-surface-hover border-at-border text-at-accent">
                    가이드 닫기
                </Button>
            </div>
        </div>
