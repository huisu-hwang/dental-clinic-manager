    ...
    <div className="space-y-6">
      ...
      <div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          <div className="bg-at-surface-alt rounded-xl p-4 border border-at-border">
            <div className="text-xs font-medium text-at-text-weak uppercase tracking-wider">총 근무일</div>
            <div className="text-2xl font-bold text-at-text mt-1">{stats.total}일</div>
          </div>
          <div className="bg-at-success-bg rounded-xl p-4 border border-green-200">
            <div className="text-xs font-medium text-at-success uppercase tracking-wider">출근일</div>
            <div className="text-2xl font-bold text-at-success mt-1">{stats.present}일</div>
          </div>
      ...
      <div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
          ...
          <div>
            <label className="block text-sm font-medium text-at-text-secondary mb-1.5">상태</label>
            <select
              value={statusFilter}
          ...
          <table className="w-full text-sm">
            <thead>
              <tr className="bg-at-surface-alt border-b border-at-border">
                <th className="px-4 py-3 text-left text-xs font-semibold text-at-text-secondary uppercase tracking-wider">날짜</th>
                <th className="px-4 py-3 text-left text-xs font-semibold text-at-text-secondary uppercase tracking-wider">상태</th>
                <th className="px-4 py-3 text-left text-xs font-semibold text-at-text-secondary uppercase tracking-wider">출근</th>
                <th className="px-4 py-3 text-left text-xs font-semibold text-at-text-secondary uppercase tracking-wider">퇴근</th>
                <th className="px-4 py-3 text-left text-xs font-semibold text-at-text-secondary uppercase tracking-wider">근무시간</th>
                <th className="px-4 py-3 text-left text-xs font-semibold text-at-text-secondary uppercase tracking-wider">지각/조퇴</th>
                <th className="px-4 py-3 text-left text-xs font-semibold text-at-text-secondary uppercase tracking-wider">초과근무</th>
              </tr>
            </thead>
              ...
              {loading ? (
                ...
                records.map((record) => (
                  <tr key={record.id} className="hover:bg-at-surface-alt">
                    <td className="px-4 py-3 whitespace-nowrap text-at-text">
                    ...
                    <td className="px-4 py-3 whitespace-nowrap text-at-text">
                      ...
                      {record.scheduled_start && (
                        <span className="ml-1 text-xs text-at-text-weak">
                    ...
                    <td className="px-4 py-3 whitespace-nowrap text-at-text font-medium">
                      {formatMinutes(record.total_work_minutes)}
                    </td>
                    <td className="px-4 py-3 whitespace-nowrap text-sm">
                      {record.late_minutes > 0 && (
                        <span className="text-at-warning font-medium">지각 {record.late_minutes}분</span>
                      )}
                    ...
                    <td className="px-4 py-3 whitespace-nowrap text-at-success font-medium">
