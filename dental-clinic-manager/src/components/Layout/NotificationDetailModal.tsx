      ...
      <Dialog as="div" className="relative z-50" onClose={onClose}>
        ...
        <div className="fixed inset-0 overflow-y-auto">
          <div className="flex min-h-full items-center justify-center p-4 text-center">
            ...
            >
              <Dialog.Panel className="w-full max-w-md transform overflow-hidden rounded-2xl bg-card text-left align-middle shadow-[var(--shadow-modal)] transition-all">
                {/* 헤더 */}
                  ...
                  <div className="flex items-start justify-between">
                    <div className="flex items-center gap-3">
                      ...
                      <div>
                        ...
                        <Dialog.Title
                          as="h3"
                          className="text-lg font-semibold leading-6 text-text-primary mt-1"
                        >
                          {notification.title}
                        </Dialog.Title>
                      </div>
                    ...
                    <button
                      type="button"
                      className="rounded-full p-1.5 text-text-tertiary hover:text-text-secondary hover:bg-white/50 transition-colors"
                      onClick={onClose}
                    >
                ...
                <div className="px-6 py-5">
                  {notification.content ? (
                    ...
                    <p className="text-text-tertiary italic">상세 내용이 없습니다.</p>
                  )}
                </div>

                {/* 액션 버튼 - 우측 하단 배치 */}
                <div className="px-6 py-4 bg-surface-page border-t border-border">
                  <div className="flex gap-3 justify-end">
                    <button
                      type="button"
                      className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-text-secondary bg-card border border-border rounded-lg hover:bg-surface-subtle transition-colors"
                      onClick={onClose}
                    >
                      닫기
                    </button>
                    <button
                      type="button"
                      className="inline-flex items-center gap-2 px-4 py-2 text-sm font-medium text-text-secondary bg-card border border-border rounded-lg hover:bg-surface-subtle transition-colors disabled:opacity-50 disabled:cursor-not-allowed"
