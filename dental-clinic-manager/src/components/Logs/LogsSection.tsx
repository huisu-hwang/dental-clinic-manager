    ...
    <div className="space-y-6">
      ...
      {activeTab === 'gift' && (
        <div>
          ...
          <div className="border border-at-border rounded-xl overflow-hidden overflow-x-auto">
            <div className="max-h-[calc(100vh-280px)] overflow-y-auto">
              <table className="w-full text-xs sm:text-sm text-left table-fixed min-w-[720px]">
                <colgroup>
                  <col className="w-[14%]" />
                  <col className="w-[12%]" />
                  <col className="w-[22%]" />
                ...
                <thead className="bg-at-surface-alt text-at-text sticky top-0 z-10">
                  <tr>
                    <th className="px-4 py-3 sm:px-5 sm:py-3.5 font-semibold whitespace-nowrap">날짜</th>
                    <th className="px-4 py-3 sm:px-5 sm:py-3.5 font-semibold">환자명</th>
                    <th className="px-4 py-3 sm:px-5 sm:py-3.5 font-semibold">선물 종류</th>
                    <th className="px-2 py-3 sm:py-3.5 font-semibold text-center">수량</th>
                    <th className="px-4 py-3 sm:px-5 sm:py-3.5 font-semibold">리뷰</th>
                    <th className="px-4 py-3 sm:px-5 sm:py-3.5 font-semibold">비고</th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-at-border">
                  {sortedGiftLogs.map(log => (
                    <tr key={log.id} className="hover:bg-at-surface-hover transition-colors">
                      <td className="px-4 py-2.5 sm:px-5 sm:py-3 whitespace-nowrap text-at-text-secondary">{log.date}</td>
                      <td className="px-4 py-2.5 sm:px-5 sm:py-3 font-medium truncate">{log.patient_name}</td>
                      <td className="px-4 py-2.5 sm:px-5 sm:py-3 truncate">{log.gift_type}</td>
                      <td className="px-2 py-2.5 sm:py-3 text-center whitespace-nowrap">{log.quantity || 1}개</td>
                      <td className="px-4 py-2.5 sm:px-5 sm:py-3 whitespace-nowrap">
                      ...
                      <td className="px-4 py-2.5 sm:px-5 sm:py-3 text-at-text-secondary truncate">{log.notes}</td>
                    </tr>
                  ))}
                </tbody>
              </table>
