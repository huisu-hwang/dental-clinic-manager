        ...
        <table className="w-full text-sm">
          <thead>
            <tr className="bg-at-surface-alt border-b border-at-border">
              ...
              <th className="px-4 py-3 text-left text-xs font-semibold text-at-text-secondary uppercase tracking-wider">상담내용</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-at-text-secondary uppercase tracking-wider w-32">진행여부</th>
              <th className="px-4 py-3 text-left text-xs font-semibold text-at-text-secondary uppercase tracking-wider">참고사항</th>
        ...
        {consultRows.map((row, index) => (
          <div key={index} className="border border-at-border rounded-xl p-3 bg-white">
            ...
            <div className="space-y-3">
              ...
              <div>
                <label className="block text-xs font-medium text-at-text-secondary mb-1">상담내용</label>
                <input
                  type="text"
                  className="w-full px-3 py-2 border border-at-border rounded-lg text-sm focus:ring-2 focus:ring-at-accent focus:border-at-accent"
                  placeholder="상담 내용 요약"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div>
                  <label className="block text-xs font-medium text-at-text-secondary mb-1">진행여부</label>
                  <select
                ...
                <div>
                  <label className="block text-xs font-medium text-at-text-secondary mb-1">참고사항</label>
                  <input
                    type="text"
                    className="w-full px-3 py-2 border border-at-border rounded-lg text-sm focus:ring-2 focus:ring-at-accent focus:border-at-accent"
                    placeholder="참고 사항"
