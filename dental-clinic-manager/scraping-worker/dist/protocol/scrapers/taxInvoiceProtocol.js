...
/** 세금계산서 매출 (Protocol) */
export async function scrapeTaxInvoiceSalesProtocol(session, year, month) {
...
/** 세금계산서 매입 (Protocol) */
export async function scrapeTaxInvoicePurchaseProtocol(session, year, month) {
...
//# sourceMappingURL=taxInvoiceProtocol.js.map