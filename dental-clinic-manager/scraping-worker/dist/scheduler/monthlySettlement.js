...
/** 전월 결산 Job 생성 */
async function createMonthlySettlementJobs() {
...
export async function aggregateSettlement(clinicId, year, month) {
    const supabase = getSupabaseClient();
...
/** 월말 결산 스케줄러 시작 */
export function startMonthlySettlement() {
...
//# sourceMappingURL=monthlySettlement.js.map