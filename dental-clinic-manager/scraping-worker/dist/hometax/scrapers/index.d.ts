 ...
 */
export declare function runScraper(context: BrowserContext | ScrapingSession, dataType: DataType, year: number, month: number, clinicId?: string): Promise<ScrapeResult>;
/**
 * 공유 페이지로 스크래퍼 실행 (Playwright 모드 전용)
 * 이미 로드된 메인 페이지가 있을 때 goto/로그인 확인 단계를 건너뜁니다.
 */
export declare function runScraperWithPage(page: Page, session: ScrapingSession, dataType: DataType, year: number, month: number, clinicId?: string): Promise<ScrapeResult>;
/** 현재 설정된 스크래핑 모드 확인 */
